...
$subject ="Новая заявка с сайта domain11111.name";
...
$header .= "From: Новая заявка <kiryuha1905@gmail.com>\n\n";	
$mail = mail("kiryuha1905@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
